...
// ../../packages/db/src/generated/client/runtime/library.js
var require_library = __commonJS({
  "../../packages/db/src/generated/client/runtime/library.js"(exports, module) {
    "use strict";
...
`);
    ...
    var M = /* @__PURE__ */ (function() {
      ...
      return function(n, i, o, s, a, l) {
        var u, c, p, d, f, g, h, O, v, C, R, k, A, ue, Bt, U, oe, Oe, Y, pt, Lr = n.constructor, Un = n.s == i.s ? 1 : -1, z2 = n.d, L = i.d;
        if (!z2 || !z2[0] || !L || !L[0]) return new Lr(!n.s || !i.s || (z2 ? L && z2[0] == L[0] : !L) ? NaN : z2 && z2[0] == 0 || !L ? Un * 0 : Un / 0);
        for (l ? (f = 1, c = n.e - i.e) : (l = he, f = E, c = re(n.e / f) - re(i.e / f)), Y = L.length, oe = z2.length, v = new Lr(Un), C = v.d = [], p = 0; L[p] == (z2[p] || 0); p++) ;
        if (L[p] > (z2[p] || 0) && c--, o == null ? (ue = o = Lr.precision, s = Lr.rounding) : a ? ue = o + (n.e - i.e) + 1 : ue = o, ue < 0) C.push(1), g = true;
        else {
          if (ue = ue / f + 2 | 0, p = 0, Y == 1) {
            for (d = 0, L = L[0], ue++; (p < oe || d) && ue--; p++) Bt = d * l + (z2[p] || 0), C[p] = Bt / L | 0, d = Bt % L | 0;
            g = d || p < oe;
          } else {
            for (d = l / (L[0] + 1) | 0, d > 1 && (L = e(L, d, l), z2 = e(z2, d, l), Y = L.length, oe = z2.length), U = Y, R = z2.slice(0, Y), k = R.length; k < Y; ) R[k++] = 0;
            pt = L.slice(), pt.unshift(0), Oe = L[0], L[1] >= l / 2 && ++Oe;
            do
              d = 0, u = t(L, R, Y, k), u < 0 ? (A = R[0], Y != k && (A = A * l + (R[1] || 0)), d = A / Oe | 0, d > 1 ? (d >= l && (d = l - 1), h = e(L, d, l), O = h.length, k = R.length, u = t(h, R, O, k), u == 1 && (d--, r(h, Y < O ? pt : L, O, l))) : (d == 0 && (u = d = 1), h = L.slice()), O = h.length, O < k && h.unshift(0), r(R, h, k, l), u == -1 && (k = R.length, u = t(L, R, Y, k), u < 1 && (d++, r(R, Y < k ? pt : L, k, l))), k = R.length) : u === 0 && (d++, R = [0]), C[p++] = d, u && R[0] ? R[k++] = z2[U] || 0 : (R = [z2[U]], k = 1);
...
var require_client = __commonJS({
  "../../packages/db/src/generated/client/index.js"(exports2) {
    "use strict";
    ...
    exports2.Prisma.RoomScalarFieldEnum = {
      id: "id",
      slug: "slug",
      createdAt: "createdAt",
      adminId: "adminId"
    };
    exports2.Prisma.ChatScalarFieldEnum = {
      id: "id",
      roomId: "roomId",
      message: "message",
      userId: "userId"
    };
    exports2.Prisma.NormalChatScalarFieldEnum = {
      id: "id",
      roomId: "roomId",
      message: "message",
      userId: "userId"
    ...
    var config2 = {
      "generator": {
        ...
        "output": {
          "value": "C:\\D\\Programming\\CODE_Files\\DevelopmentWork\\cohort_project\\scribble_hub\\packages\\db\\src\\generated\\client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "C:\\D\\Programming\\CODE_Files\\DevelopmentWork\\cohort_project\\scribble_hub\\packages\\db\\prisma\\schema.prisma",
        "isCustomOutput": true
      },
      "relativeEnvPaths": {
        "rootEnvPath": null,
    ...
    config2.runtimeDataModel = JSON.parse('{"models":{"User":{"dbName":null,"schema":null,"fields":[{"name":"id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":true,"isReadOnly":false,"hasDefaultValue":true,"type":"String","nativeType":null,"default":{"name":"uuid","args":[4]},"isGenerated":false,"isUpdatedAt":false},{"name":"email","kind":"scalar","isList":false,"isRequired":true,"isUnique":true,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":["VarChar",["255"]],"isGenerated":false,"isUpdatedAt":false},{"name":"password","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"name","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"photo","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"chats","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Chat","nativeType":null,"relationName":"ChatToUser","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false},{"name":"rooms","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Room","nativeType":null,"relationName":"RoomToUser","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false},{"name":"normalChats","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"NormalChat","nativeType":null,"relationName":"NormalChatToUser","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false}],"primaryKey":null,"uniqueFields":[],"uniqueIndexes":[],"isGenerated":false},"Room":{"dbName":null,"schema":null,"fields":[{"name":"id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":true,"isReadOnly":false,"hasDefaultValue":true,"type":"Int","nativeType":null,"default":{"name":"autoincrement","args":[]},"isGenerated":false,"isUpdatedAt":false},{"name":"slug","kind":"scalar","isList":false,"isRequired":true,"isUnique":true,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"createdAt","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"DateTime","nativeType":null,"default":{"name":"now","args":[]},"isGenerated":false,"isUpdatedAt":false},{"name":"adminId","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"chats","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Chat","nativeType":null,"relationName":"ChatToRoom","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false},{"name":"normalChats","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"NormalChat","nativeType":null,"relationName":"NormalChatToRoom","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false},{"name":"admin","kind":"object","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"User","nativeType":null,"relationName":"RoomToUser","relationFromFields":["adminId"],"relationToFields":["id"],"isGenerated":false,"isUpdatedAt":false}],"primaryKey":null,"uniqueFields":[],"uniqueIndexes":[],"isGenerated":false},"Chat":{"dbName":null,"schema":null,"fields":[{"name":"id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":true,"isReadOnly":false,"hasDefaultValue":true,"type":"Int","nativeType":null,"default":{"name":"autoincrement","args":[]},"isGenerated":false,"isUpdatedAt":false},{"name":"roomId","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"Int","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"message","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Json","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"userId","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"room","kind":"object","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Room","nativeType":null,"relationName":"ChatToRoom","relationFromFields":["roomId"],"relationToFields":["id"],"isGenerated":false,"isUpdatedAt":false},{"name":"user","kind":"object","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"User","nativeType":null,"relationName":"ChatToUser","relationFromFields":["userId"],"relationToFields":["id"],"isGenerated":false,"isUpdatedAt":false}],"primaryKey":null,"uniqueFields":[],"uniqueIndexes":[],"isGenerated":false},"NormalChat":{"dbName":null,"schema":null,"fields":[{"name":"id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":true,"isReadOnly":false,"hasDefaultValue":true,"type":"Int","nativeType":null,"default":{"name":"autoincrement","args":[]},"isGenerated":false,"isUpdatedAt":false},{"name":"roomId","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"Int","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"message","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"userId","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"room","kind":"object","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Room","nativeType":null,"relationName":"NormalChatToRoom","relationFromFields":["roomId"],"relationToFields":["id"],"isGenerated":false,"isUpdatedAt":false},{"name":"user","kind":"object","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"User","nativeType":null,"relationName":"NormalChatToUser","relationFromFields":["userId"],"relationToFields":["id"],"isGenerated":false,"isUpdatedAt":false}],"primaryKey":null,"uniqueFields":[],"uniqueIndexes":[],"isGenerated":false}},"enums":{},"types":{}}');
...
// ../../packages/common/server.address.ts
var BACKEND_URL = process.env.NEXT_PUBLIC_BACKEND_URL || process.env.BACKEND_URL || "http://localhost:3000";
var WS_URL = process.env.NEXT_PUBLIC_WS_URL || process.env.WS_URL || "ws://localhost:3002";
var FRONTEND_URL = process.env.NEXT_PUBLIC_FRONTEND_URL || process.env.FRONTEND_URL || "http://localhost:3003";
var JWT_SECRET = process.env.JWT_SECRET || "Dipesh";
var LLM_URL = process.env.LLM_URL || "Dipesh";
var LLM_TOKEN = process.env.LLM_TOKEN || "Dipesh";
...
var signup = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ message: typeof e === "string" ? e : e.message });
  }
};
...
var updateProfile = async (req, res) => {
  try {
    ...
    const newName = typeof name === "string" && name.trim() ? name.trim() : void 0;
    const newEmail = typeof email === "string" && email.trim() ? email.trim() : void 0;
    const newPhoto = typeof photo === "string" && photo.trim() ? photo.trim() : void 0;
...
var getRoomBySlug = async (req, res) => {
  const slug = req.params.slug;
  const room = await prismaClient.room.findFirst({ where: { slug } });
  res.json({ room });
};
var getUserRooms = async (req, res) => {
  try {
    const userId = req.userId;
...
var getChatsByRoomId = async (req, res) => {
  try {
...
function middleware(req, res, next) {
  ...
  const token1 = authHeader.startsWith("Bearer ") ? authHeader.split(" ")[1] : "";
  const decoded = import_jsonwebtoken2.default.verify(token1 || "", JWT_SECRET);
  if (decoded) {
...
var allowedOrigins = [
  ...
  "http://localhost:3003",
  // standard next.js port
  "https://scribbledraw-frontend.vercel.app",
  // Your production frontend origin
  process.env.FRONTEND_URL?.replace(/['";\s]/g, ""),
  // Clean trailing semicolons, spaces, or quotes
...
app.use((0, import_cors.default)({
  ...
  credentials: true,
  // Allow tokens/cookies if needed
